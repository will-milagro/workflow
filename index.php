...
<html lang="en">
    ...
    <body>
        ...
        <nav id="main-nav">
        ...
        </nav>		<div id="slider" class="slider-col">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6 serv-round">
